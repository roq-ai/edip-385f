...
import { getLoanDetailById } from 'apiSdk/loan-details';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Loan Detail Detail View
          </Text>
          {hasAccess('loan_detail', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/loan-details/edit/${data?.id}`} passHref legacyBehavior>
              <Button
