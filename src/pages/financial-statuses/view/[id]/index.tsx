...
import { getFinancialStatusById } from 'apiSdk/financial-statuses';
...
function FinancialStatusViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Financial Status Detail View
          </Text>
          {hasAccess('financial_status', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/financial-statuses/edit/${data?.id}`} passHref legacyBehavior>
              <Button
